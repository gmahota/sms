...
FlowRouter.route('/print-result/:id', {
	name: 'printSingleResult',
	action(){
		BlazeLayout.render('printLayout', { main: 'resultPrint' });
	}
});
FlowRouter.route('/edit-result/:id', {
	name: 'editSingleResult',
	action(){
		BlazeLayout.render('mainLayout', { main: 'resultEdit' });
	}
});
...
FlowRouter.route('/edit-timetable/:id', {
	name: 'editSingleTimetable',
	action(){
		BlazeLayout.render('mainLayout', { main: 'timetableEdit' });
	}
});
FlowRouter.route('/add-timetable', {
	name: 'addTimetable',
	action(){
		BlazeLayout.render('mainLayout', { main: 'addTimetable' });
	}
});

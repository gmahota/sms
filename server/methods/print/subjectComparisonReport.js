Meteor.methods({
    'subjectComparisonClassReport': function(classId, examId) {
        if (Meteor.isServer) {
          // SETUP
          ...
          var fileName = "subject-comparison-report.pdf";
          ...
          SSR.compileTemplate('template', Assets.getText('subject-comparison-report.html'));
            ...
            var studentArray = Students.find({class: classId}).map(function(student){
                return student._id;
            });

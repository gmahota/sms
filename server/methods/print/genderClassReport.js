Meteor.methods({
    'classGenderResultsPdf': function(classId, examId, gender) {
        if (Meteor.isServer) {
          // SETUP
          ...
          var fileName = "gender-class-report.pdf";
          ...
          SSR.compileTemplate('gender_class_report', Assets.getText('gender-class-report.html'));

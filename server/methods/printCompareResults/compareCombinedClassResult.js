Meteor.methods({
    'compareCombinedClassResult': function(yearId, termName, form) {
        if (Meteor.isServer) {
            var webshot = Meteor.npmRequire('webshot');
            var fs      = Npm.require('fs');
            var Future = Npm.require('fibers/future');
            var fut = new Future();
            var fileName = "compare-combined-class-result.pdf";
            ...
            SSR.compileTemplate('template', Assets.getText('compare-combined-class-result.html'));
            //========================================

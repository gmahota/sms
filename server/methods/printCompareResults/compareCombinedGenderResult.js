Meteor.methods({
    'compareCombinedGenderResult': function(yearId, termName, form, gender) {
        if (Meteor.isServer) {
            var webshot = Meteor.npmRequire('webshot');
            var fs      = Npm.require('fs');
            var Future = Npm.require('fibers/future');
            var fut = new Future();
            var fileName = "compare-combined-gender-result.pdf";
            ...
            SSR.compileTemplate('template', Assets.getText('compare-combined-gender-result.html'));
            //========================================
